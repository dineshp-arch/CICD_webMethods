...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="DeployerSpec/Environment">
    <Environment>
      ...
      <TargetGroup description="" isLogicalCluster="false" type="ProcessModel">
		<xsl:attribute name="name">
          <xsl:value-of select="$targetClusterGroupAlias"/>
        </xsl:attribute>
		<alias type="ProcessModel" />
    ...
    <Projects>
      ...
      <Project  type="Repository" overwrite="true" ignoreMissingDependencies="true">
        ...
        <DeploymentSet autoResolve="ignore">
          ...
          <xsl:attribute name="description">
            <xsl:value-of select="concat($projectName,' BPM DeploymentSet')"/>
          </xsl:attribute>
		...
		<DeploymentMap>			
	         <xsl:attribute name="description">
	            <xsl:value-of select="concat($projectName,' BPM Deployment Map')"/>
	         </xsl:attribute>
		...
		<DeploymentCandidate>
	         ...
	         <xsl:attribute name="description">
	            <xsl:value-of select="concat($projectName,' BPM Deployment Candidate')"/>
	         </xsl:attribute>
